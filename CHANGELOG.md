...
All notable changes to the Claude Bridge project will be documented in this file.
...
- **[2025-11-21] MCP Tool Authentication Failure** - Fixed `restart_dev_server` and other MCP tools failing with "Authentication required" when calling Bridge APIs
  ...
  - **Files Changed:**
    ...
    - Updated `packages/tools/src/lib/bridge-api-client.ts` to import from shared package
