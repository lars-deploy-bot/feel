module.exports = [
"[project]/node_modules/@anthropic-ai/claude-agent-sdk/sdk.mjs [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$readline__$5b$external$5d$__$28$readline$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/readline [external] (readline, cjs)");
...
const __TURBOPACK__import$2e$meta__ = {
    get url () {
        return `file://${__turbopack_context__.P("node_modules/@anthropic-ai/claude-agent-sdk/sdk.mjs")}`;
    }
};
...
var require_uri_all = __commonJS((exports, module)=>{
    (function(global2, factory) {
        typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? ((r)=>r !== undefined && __turbopack_context__.v(r))(factory(exports)) : factory(global2.URI = global2.URI || {});
        ...
        function _normalizeComponentEncoding(components, protocol) {
            ...
            if (components.userinfo !== undefined) components.userinfo = String(components.userinfo).replace(protocol.PCT_ENCODED, decodeUnreserved2).replace(protocol.NOT_USERINFO, pctEncChar).replace(protocol.PCT_ENCODED, toUpperCase);
            if (components.host !== undefined) components.host = String(components.host).replace(protocol.PCT_ENCODED, decodeUnreserved2).toLowerCase().replace(protocol.NOT_HOST, pctEncChar).replace(protocol.PCT_ENCODED, toUpperCase);
            if (components.path !== undefined) components.path = String(components.path).replace(protocol.PCT_ENCODED, decodeUnreserved2).replace(components.scheme ? protocol.NOT_PATH : protocol.NOT_PATH_NOSCHEME, pctEncChar).replace(protocol.PCT_ENCODED, toUpperCase);
            if (components.query !== undefined) components.query = String(components.query).replace(protocol.PCT_ENCODED, decodeUnreserved2).replace(protocol.NOT_QUERY, pctEncChar).replace(protocol.PCT_ENCODED, toUpperCase);
            if (components.fragment !== undefined) components.fragment = String(components.fragment).replace(protocol.PCT_ENCODED, decodeUnreserved2).replace(protocol.NOT_FRAGMENT, pctEncChar).replace(protocol.PCT_ENCODED, toUpperCase);
            return components;
        }
    ...
    function checkDataTypes(dataTypes, data, strictNumbers) {
        switch(dataTypes.length){
            ...
            default:
                ...
                for(var t in types2)code += (code ? " && " : "") + checkDataType(t, data, strictNumbers, true);
                return code;
        }
    }
...
var require_resolve = __commonJS((exports, module)=>{
    ...
    var PREVENT_SCOPE_CHANGE = util3.toHash([
        "properties",
        "patternProperties",
        "enum",
        "dependencies",
    ...
    function getJsonPointer(parsedRef, baseId, schema, root2) {
        ...
        if (schema !== undefined && schema !== root2.schema) return {
            schema,
            root: root2,
            baseId
        };
    ...
    function resolveIds(schema) {
        ...
        traverse(schema, {
            ...
            if (keyIndex !== undefined) fullPath += "/" + (typeof keyIndex == "number" ? keyIndex : util3.escapeFragment(keyIndex));
            if (typeof id == "string") {
...
var require_compile = __commonJS((exports, module)=>{
    ...
    function compile(schema, root2, localRefs, baseId) {
        ...
        function localCompile(_schema, _root, localRefs2, baseId2) {
            ...
            if (_root.schema != root2.schema) return compile.call(self2, _schema, _root, localRefs2, baseId2);
                ...
                return schemaPromise.then(function(sch) {
                    if (!added(ref)) {
                        return loadMetaSchemaOf(sch).then(function() {
                            if (!added(ref)) self2.addSchema(sch, ref, undefined, meta);
                        });
                    }
                }).then(function() {
...
function createAbortController(maxListeners = DEFAULT_MAX_LISTENERS) {
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$events__$5b$external$5d$__$28$events$2c$__cjs$29$__["setMaxListeners"])(maxListeners, controller.signal);
    return controller;
}
;
;
...
var NodeFsOperations = {
    ...
    existsSync (fsPath) {
        return __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["existsSync"](fsPath);
    },
    async stat (fsPath) {
        return (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["stat"])(fsPath);
    },
    statSync (fsPath) {
        return __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["statSync"](fsPath);
    },
    readFileSync (fsPath, options) {
        return __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["readFileSync"](fsPath, {
    ...
    readSync (fsPath, options) {
        let fd = undefined;
        try {
            fd = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["openSync"](fsPath, "r");
            const buffer = Buffer.alloc(options.length);
            const bytesRead = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["readSync"](fd, buffer, 0, options.length, 0);
            return {
                buffer,
                bytesRead
            };
        } finally{
            if (fd) __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["closeSync"](fd);
        }
    },
    writeFileSync (fsPath, data, options) {
        if (!options.flush) {
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["writeFileSync"](fsPath, data, writeOptions);
            return;
        }
        let fd;
        try {
            const mode = options.mode !== undefined ? options.mode : undefined;
            fd = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["openSync"](fsPath, "w", mode);
            __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["writeFileSync"](fd, data, {
                encoding: options.encoding
            });
            __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["fsyncSync"](fd);
        } finally{
            if (fd) {
    ...
    appendFileSync (path, data) {
        __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["appendFileSync"](path, data);
    },
    copyFileSync (src, dest) {
        __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["copyFileSync"](src, dest);
    },
    unlinkSync (path) {
        __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["unlinkSync"](path);
    },
    renameSync (oldPath, newPath) {
        __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["renameSync"](oldPath, newPath);
    },
    linkSync (target, path) {
        __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["linkSync"](target, path);
    },
    symlinkSync (target, path) {
        __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["symlinkSync"](target, path);
    },
    readlinkSync (path) {
        return __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["readlinkSync"](path);
    },
    realpathSync (path) {
        return __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["realpathSync"](path);
    },
    mkdirSync (dirPath) {
    ...
    readdirSync (dirPath) {
        return __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["readdirSync"](dirPath, {
            withFileTypes: true
        });
    },
    ...
    rmdirSync (dirPath) {
        __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["rmdirSync"](dirPath);
    },
    rmSync (path, options) {
        __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["rmSync"](path, options);
    },
    createWriteStream (path) {
        return __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["createWriteStream"](path);
    }
};
...
class ProcessTransport {
    ...
    initialize() {
        try {
            const { additionalDirectories = [], agents, cwd, executable = isRunningWithBun() ? "bun" : "node", executableArgs = [], extraArgs = {}, pathToClaudeCodeExecutable, env = {
                ...process.env
            }, stderr, customSystemPrompt, appendSystemPrompt, maxThinkingTokens, maxTurns, maxBudgetUsd, model, fallbackModel, permissionMode, allowDangerouslySkipPermissions, permissionPromptToolName, continueConversation, resume, settingSources, allowedTools = [], disallowedTools = [], mcpServers, strictMcpConfig, canUseTool, includePartialMessages, plugins } = this.options;
            const args = [
                "--output-format",
                "stream-json",
                "--verbose",
            ...
            if (typeof customSystemPrompt === "string") args.push("--system-prompt", customSystemPrompt);
            ...
            this.child = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$child_process__$5b$external$5d$__$28$child_process$2c$__cjs$29$__["spawn"])(spawnCommand, spawnArgs, {
                cwd,
                stdio: [
                    "pipe",
                    "pipe",
...
`);
    ...
    async *readMessages() {
        ...
        const rl = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$readline__$5b$external$5d$__$28$readline$2c$__cjs$29$__["createInterface"])({
...
function getClaudeConfigHomeDir() {
    return process.env.CLAUDE_CONFIG_DIR ?? (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["join"])((0, __TURBOPACK__imported__module__$5b$externals$5d2f$os__$5b$external$5d$__$28$os$2c$__cjs$29$__["homedir"])(), ".claude");
}
...
function getInitialState() {
    const resolvedCwd = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["realpathSync"])((0, __TURBOPACK__imported__module__$5b$externals$5d2f$process__$5b$external$5d$__$28$process$2c$__cjs$29$__["cwd"])());
    return {
        ...
        sessionId: (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomUUID"])(),
        loggerProvider: null,
        eventLogger: null,
        meterProvider: null,
        tracerProvider: null,
...
`;
    ...
    if (!getFsImplementation().existsSync((0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["dirname"])(getDebugLogPath()))) {
        getFsImplementation().mkdirSync((0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["dirname"])(getDebugLogPath()));
    }
    getFsImplementation().appendFileSync(getDebugLogPath(), output);
    updateLatestDebugLogSymlink();
}
function getDebugLogPath() {
    return process.env.CLAUDE_CODE_DEBUG_LOGS_DIR ?? (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["join"])(getClaudeConfigHomeDir(), "debug", `${getSessionId()}.txt`);
}
var updateLatestDebugLogSymlink = memoize_default(()=>{
    try {
        const debugLogPath = getDebugLogPath();
        const debugLogsDir = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["dirname"])(debugLogPath);
        const latestSymlinkPath = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["join"])(debugLogsDir, "latest");
...
var ProgressTokenSchema = exports_external.union([
...
var RequestIdSchema = exports_external.union([
    exports_external.string(),
    exports_external.number().int()
]);
...
var ReadResourceResultSchema = ResultSchema.extend({
    contents: exports_external.array(exports_external.union([
...
var EmbeddedResourceSchema = exports_external.object({
    ...
    resource: exports_external.union([
        TextResourceContentsSchema,
        BlobResourceContentsSchema
    ]),
    _meta: exports_external.optional(exports_external.object({}).passthrough())
...
var CreateMessageRequestSchema = RequestSchema.extend({
    ...
    params: BaseRequestParamsSchema.extend({
        ...
        includeContext: exports_external.optional(exports_external.enum([
            "none",
            "thisServer",
            "allServers"
        ])),
...
var CreateMessageResultSchema = ResultSchema.extend({
    ...
    stopReason: exports_external.optional(exports_external.enum([
        "endTurn",
        "stopSequence",
        "maxTokens"
    ]).or(exports_external.string())),
    role: exports_external.enum([
        "user",
        "assistant"
    ]),
...
var StringSchemaSchema = exports_external.object({
    ...
    format: exports_external.optional(exports_external.enum([
        "email",
        "uri",
        "date",
        "date-time"
...
function parseUnionDef(def, refs) {
    ...
    if (options.every((x)=>x._def.typeName in primitiveMappings && (!x._def.checks || !x._def.checks.length))) {
        const types2 = options.reduce((types3, x)=>{
            ...
            return type && !types3.includes(type) ? [
                ...types3,
                type
            ] : types3;
        }, []);
    ...
    _createRegisteredPrompt(name, title, description, argsSchema, callback) {
        const registeredPrompt = {
            ...
            update: (updates)=>{
                ...
                if (typeof updates.argsSchema !== "undefined") registeredPrompt.argsSchema = exports_external.object(updates.argsSchema);
    ...
    _createRegisteredTool(name, title, description, inputSchema, outputSchema, annotations, callback) {
        const registeredTool = {
            ...
            update: (updates)=>{
                ...
                if (typeof updates.paramsSchema !== "undefined") registeredTool.inputSchema = exports_external.object(updates.paramsSchema);
...
function query({ prompt, options }) {
    ...
    if (!pathToClaudeCodeExecutable) {
        ...
        const dirname2 = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["join"])(filename, "..");
        pathToClaudeCodeExecutable = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["join"])(dirname2, "cli.js");
    }
    process.env.CLAUDE_AGENT_SDK_VERSION = "0.1.30";
    const { abortController = createAbortController(), additionalDirectories = [], agents, allowedTools = [], canUseTool, continue: continueConversation, cwd: cwd2, disallowedTools = [], env, executable = isRunningWithBun() ? "bun" : "node", executableArgs = [], extraArgs = {}, fallbackModel, forkSession, hooks, includePartialMessages, maxThinkingTokens, maxTurns, maxBudgetUsd, mcpServers, model, permissionMode = "default", allowDangerouslySkipPermissions = false, permissionPromptToolName, plugins, resume, resumeSessionAt, stderr, strictMcpConfig } = rest;
    let processEnv = env;
    if (!processEnv) {
        processEnv = {
            ...process.env
...
//# sourceMappingURL=node_modules_%40anthropic-ai_claude-agent-sdk_sdk_mjs_2da8abf1._.js.map