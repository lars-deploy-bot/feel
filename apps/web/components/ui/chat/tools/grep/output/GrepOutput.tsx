type GrepOutputProps =
	| GrepContentOutputProps
	| GrepFilesOutputProps
	| GrepCountOutputProps
				...
				<div className="space-y-3 max-h-80 overflow-auto">
					{props.matches.map((match, index) => (
						<div key={index} className="space-y-1">
							...
							<div className="text-xs text-black/80 font-diatype-mono pl-2 bg-yellow-50">
								{match.line}
							</div>
