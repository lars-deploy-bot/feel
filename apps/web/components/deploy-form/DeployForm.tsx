...
export function DeployForm() {
  ...
  const watchPassword = deploymentMode === "deploy-with-domain"
    ? deployWithDomainForm.watch("password")
    : deployOnlyForm.watch("password")
  ...
  const onSubmitDeployOnly = async (data: DeployOnlyInput): Promise<void> => {
  ...
  const isWithDomain = deploymentMode === "deploy-with-domain"
