    ...
    <>
      ...
      {isOpen && (
        <button
          type="button"
          onClick={onClose}
          className="fixed inset-0 bg-black/20 dark:bg-black/40 z-40 transition-opacity cursor-default"
      ...
      <div
        ref={panelRef}
        className={`fixed right-0 top-0 bottom-0 w-full max-w-2xl bg-white dark:bg-neutral-950 border-l border-black/10 dark:border-white/10 shadow-2xl z-50 transition-transform duration-300 overflow-hidden flex flex-col ${
