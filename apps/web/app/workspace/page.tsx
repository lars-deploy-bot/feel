  ...
  return (
    <main className="max-w-2xl mx-auto my-10 p-4">
      <h1 className="text-3xl font-bold mb-6">
        Workspace Setup - Terminal Mode
      </h1>

      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        <h2 className="font-semibold text-blue-800 mb-2">Terminal Mode Active</h2>
        <p className="text-blue-700 text-sm">
          You're using terminal mode which allows you to specify a custom workspace directory.
          Please verify your workspace before proceeding to chat.
        </p>
      </div>
      ...
      <div className="space-y-6">
        <div>
          ...
          {verifyResult && (
            <div className={`mt-3 p-4 rounded text-sm ${
