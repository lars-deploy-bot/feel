                  ...
                  {result.debug && (
                    <div className="p-3 bg-gray-50 border border-gray-200 rounded-md">
                      ...
                      <div className="text-sm text-gray-700 space-y-1 font-mono">
                        <div><strong>Groq Status:</strong> {result.debug.groqStatus}</div>
                        <div><strong>Has GROQ_API_SECRET:</strong> {result.debug.hasGroqSecret ? 'Yes' : 'No'}</div>
                        {result.debug.groqError && (
                          <div className="text-red-600"><strong>Groq Error:</strong> {result.debug.groqError}</div>
                        )}
                        <div><strong>Raw Groq Response:</strong> "{result.debug.rawGroqResponse}"</div>
                        <div><strong>Input:</strong> "{result.debug.input}"</div>
                      </div>
                    </div>
                  )}
                </div>
