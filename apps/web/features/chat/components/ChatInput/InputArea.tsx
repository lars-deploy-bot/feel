  ...
  return (
    <div className="relative">
      ...
      <textarea
        ...
        className="w-full resize-none break-words border-0 bg-transparent text-base leading-relaxed font-normal focus:outline-none py-3 px-4 text-black dark:text-white placeholder:text-black/30 dark:placeholder:text-white/30 no-scrollbar"
        rows={1}
