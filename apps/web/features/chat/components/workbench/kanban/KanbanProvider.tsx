...
export function KanbanProvider({ adapter, children }: { adapter: KanbanAdapter; children: ReactNode }) {
  ...
  const value: KanbanContextValue = useMemo(
    ...
    [
      adapter, cards, cardsByColumn, isLoading, sortField,
      moveMut, createMut, updateMut, deleteMut,
      focus, selected, toggleSelect, clearSelection,
      draggedId, editingCardId, creatingInColumn, showShortcuts,
    ],
  )
