...
const SEED_CARDS: KanbanCard[] = [
  {
    id: "c1", columnId: "todo", order: 0, priority: "high",
  ...
  {
    id: "c2", columnId: "todo", order: 1, priority: "medium",
  ...
  {
    id: "c3", columnId: "todo", order: 2, priority: "low",
  ...
  {
    id: "c4", columnId: "in-progress", order: 0, priority: "high",
  ...
  {
    id: "c5", columnId: "in-progress", order: 1, priority: "urgent",
  ...
  {
    id: "c6", columnId: "review", order: 0, priority: "medium",
  ...
  {
    id: "c7", columnId: "review", order: 1, priority: "medium",
  ...
  {
    id: "c8", columnId: "done", order: 0, priority: "none",
  ...
  {
    id: "c9", columnId: "done", order: 1, priority: "none",
