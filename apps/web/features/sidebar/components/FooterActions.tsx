...
export function FooterActions({ onOpenInvite, isMobile }: { onOpenInvite: () => void; isMobile?: boolean }) {
  if (!REFERRAL.ENABLED) {
    return isMobile ? <div className={styles.panel} style={{ height: "env(safe-area-inset-bottom, 0px)" }} /> : null
  }
