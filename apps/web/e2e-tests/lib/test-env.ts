...
/** Server 2 (sonno.tech) IP — has no local template sites */
const SERVER_2_IP = "95.217.89.48"
 ...
 */
export const hasLocalTemplates = process.env.NEXT_PUBLIC_SERVER_IP !== SERVER_2_IP
