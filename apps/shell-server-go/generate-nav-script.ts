 ...
 *
 * Run: bun apps/shell-server-go/generate-nav-script.ts
 * Called automatically by: bun run --cwd apps/shell-server-go generate
 */
...
const outPath = join(import.meta.dir, "internal", "preview", "nav_script.go")
...
if (!written.includes("package preview")) {
  throw new Error("[generate-nav-script] FATAL: Written file does not contain 'package preview'")
}
