---
name: 3D Folder Animation
description: Interactive 3D folder that opens on hover with smooth CSS transforms and paper reveal effect
...
tags:
  ...
  - animation
  - files
previewImage: https://images.unsplash.com/photo-1544396821-4dd40b938ad3?w=800&h=600&fit=crop
enabled: true
---
...
:root {
  ...
  --radius: 0.75rem;
  --folder-back: oklch(0.75 0.12 45);
  --folder-front: oklch(0.8 0.14 50);
  --folder-tab: oklch(0.7 0.1 40);
}
