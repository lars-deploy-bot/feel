...
// Define available guide categories (supports paths like "extra/knowledge-base")
...
/**
 * Business logic: Retrieve guide content from the internals documentation.
 * Searches through various guide categories and returns relevant content.
 */
export async function getGuide(params: GetGuideParams, guidesBasePath: string): Promise<GetGuideResult> {
  try {
    ...
    // Support paths like "extra/knowledge-base"
    ...
    // Read the first matching file (or all if no topic specified)
