...
function generateService(cfg: ServiceConfig): string {
  ...
  const extraEnvLines = cfg.envVars
    ? Object.entries(cfg.envVars)
...
async function main() {
  ...
  const services: ServiceConfig[] = [
    ...
    },
    {
      ...
      workingDir: aliveRoot,
      execStart: `${bunPath} ${aliveRoot}/.builds/staging/standalone/apps/web/server.js`,
      port: 8998,
      env: "production",
      envFiles: [`${aliveRoot}/.env.local`, `${aliveRoot}/apps/web/.env.staging`],
      envVars: { NODE_PATH: `${aliveRoot}/node_modules` },
    ...
    },
    {
      ...
      workingDir: aliveRoot,
      execStart: `${bunPath} ${aliveRoot}/.builds/production/standalone/apps/web/server.js`,
      port: 9000,
      env: "production",
