...
const THINKING_POOLS: Partial<Record<VoiceLanguage, string[]>> = {
  en: [
    ...
    "Gandalf didn't rush either",
    "even Einstein needed a sec",
  ],
  nl: [
    "even nadenken",
    "momentje hoor",
    ...
    "hersenpan staat op standje turbo",
    "ik geef het m'n alles",
    "even de bovenkamer raadplegen",
    "koffie erbij en gaan",
    "de radartjes draaien",
    "ik zit er bovenop",
    "breinstorm in volle gang",
    "ff serieus m'n best doen",
    "de hamster draait op volle toeren",
    "effe op het puntje van m'n stoel",
    "Cruijff had ook even nodig",
    "even aan Sinterklaas vragen",
    "schijnt de zon al?",
    "ff een frikandelbroodje erbij",
    "Tikkiee tikkie even wachten",
  ],
  de: [
    "denke nach",
    "Moment mal",
    ...
    "Denkmodus aktiviert",
    "Hamsterrad läuft",
    "Oberstübchen arbeitet",
    "volle Konzentration",
    "Birne glüht",
    "läuft bei mir gleich",
    "Denkfabrik ist geöffnet",
    "ich geb alles",
    "Gehirn macht brrr",
    "Grübelmodus an",
    "gleich kommt der Geistesblitz",
    "Loriot: Ach was",
    "selbst Einstein brauchte kurz",
    "Pumuckl war auch nicht schneller",
  ],
}
