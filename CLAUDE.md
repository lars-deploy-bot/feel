...
20. **GENERATED TYPES ARE GENERATED** - Files in `packages/database/src/*.generated.ts` are auto-generated by `bun run gen:types`. NEVER edit them manually. If the types are wrong, fix the database schema and regenerate.
