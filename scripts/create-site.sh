...
TEMPLATE_DIR="/root/webalive/claude-bridge/packages/template"
...
See \`/root/webalive/claude-bridge/packages/template/DEPLOYMENT.md\` for detailed manual deployment instructions.
